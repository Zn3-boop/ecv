"""
使用OpenRouter API进行测试（免费试用额度）
OpenRouter配置：
- API URL: https://openrouter.ai/api/v1/chat/completions
- 免费模型: google/gemini-2.0-flash-exp (免费试用)
...
print("=" * 70)
print("使用OpenRouter API测试")
print("=" * 70)

# OpenRouter API配置
API_URL = "https://openrouter.ai/api/v1/chat/completions"
API_KEY = "sk-or-v1-xxxxx"  # 用户需要替换为自己的API Key

print("\nOpenRouter API配置信息:")
print("- API URL: https://openrouter.ai/api/v1/chat/completions")
print("- 免费模型: google/gemini-2.0-flash-exp")
print("- 获取Key: https://openrouter.ai/keys")

# 检查是否有API Key
if API_KEY == "sk-or-v1-xxxxx":
    print("\n⚠️ 请先获取OpenRouter API Key:")
    ...
    # 打开网页
    subprocess.Popen(["start", "msedge", "https://openrouter.ai/keys"], shell=True)
    print("✅ 已打开OpenRouter注册页面")
    exit()
...
try:
    print("正在生成登录页面...")
    r1 = requests.post(API_URL, headers=headers, json=data1, timeout=60)
    ...
    if r1.status_code == 200:
        ...
        print("❌ 访问被禁止，可能需要地区许可或API Key无效")
        print("尝试使用其他模型...")
    else:
...
# ===== 任务2: 生成论文 =====
print("\n" + "=" * 70)
print("[任务2] 使用OpenRouter生成论文 + 浏览器搜索")
print("=" * 70)
